<template>
  <div class="answer" :class="{ dark: $store.state.isDarkMode }">
    <div class="left">
      <div class="avatars">
        <i
    ...
    <div class="center">
      <div class="text">
        ...
        <span v-if="data.referenceItem.type === 'QUESTION'">回答了你</span>
...
div.answer.dark div.text {
  color: #bbb;
}
div.text > a {
  color: #000;
}
div.answer.dark div.text > a {
  color: #fff;
}
div.content {
  display: block;
