<template>
  <div class="mention" :class="{ dark: $store.state.isDarkMode }">
    <div class="left">
      <div class="avatars">
        <i
    ...
    <div class="center">
      <div class="text">
        ...
        <span v-if="data.referenceItem.type === 'QUESTION'">@了你</span>
...
div.mention.dark div.avatars > i {
...
div.mention.dark div.text {
  color: #bbb;
}
div.text > a {
  color: #000;
}
div.mention.dark div.text > a {
  color: #fff;
}
div.content {
  display: block;
