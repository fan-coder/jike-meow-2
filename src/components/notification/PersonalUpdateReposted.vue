<template>
  <div class="repost" :class="{ dark: $store.state.isDarkMode }">
    <div class="left">
      <div class="avatars">
        <i
    ...
    <div class="center">
      <div class="text">
        ...
        <span v-if="data.referenceItem.type === 'QUESTION'">转发了你的动态</span>
...
div.repost.dark div.text {
  color: #bbb;
}
div.text > a {
  color: #000;
}
div.repost.dark div.text > a {
  color: #fff;
}
div.content {
  display: block;
